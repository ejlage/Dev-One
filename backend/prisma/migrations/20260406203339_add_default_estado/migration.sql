...
CREATE TABLE "anuncio" (
    ...
    "direcaoutilizadoriduser" INTEGER NOT NULL,
...
CREATE TABLE "disponibilidade" (
    ...
    "datainicio" DATE NOT NULL,
    "datafim" TIME(6) NOT NULL,
    "duracaominima" TIME(6) NOT NULL,
    "duracaomaxima" TIME(6) NOT NULL,
    "modalidadeprofessoridmodalidadeprofessor" INTEGER NOT NULL,
    "tipoaulaidtipoaula" INTEGER NOT NULL,
    "professorutilizadoriduser" INTEGER NOT NULL,
...
CREATE TABLE "figurino" (
    ...
    "direcaoutilizadoriduser" INTEGER NOT NULL,
    "professorutilizadoriduser" INTEGER NOT NULL,
    "itemfigurinoiditem" INTEGER NOT NULL,
...
CREATE TABLE "pedidodeaula" (
    ...
    "disponibilidadeiddisponibilidade" INTEGER NOT NULL,
    "grupoidgrupo" INTEGER NOT NULL,
    "estadoidestado" INTEGER NOT NULL,
    "salaidsala" INTEGER NOT NULL,
    "encarregadoeducacaoutilizadoriduser" INTEGER NOT NULL,
...
CREATE TABLE "tipoaula" (
    "idtipoaula" SERIAL NOT NULL,
    "nometipoaula" VARCHAR(255) NOT NULL,

    CONSTRAINT "tipoaula_pkey" PRIMARY KEY ("idtipoaula")
);
...
-- AddForeignKey
ALTER TABLE "disponibilidade" ADD CONSTRAINT "fkdisponibil276660" FOREIGN KEY ("modalidadeprofessoridmodalidadeprofessor") REFERENCES "modalidadeprofessor"("idmodalidadeprofessor") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "disponibilidade" ADD CONSTRAINT "fkdisponibil315555" FOREIGN KEY ("tipoaulaidtipoaula") REFERENCES "tipoaula"("idtipoaula") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "disponibilidade" ADD CONSTRAINT "fkdisponibil456629" FOREIGN KEY ("professorutilizadoriduser") REFERENCES "professor"("utilizadoriduser") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "pedidodeaula" ADD CONSTRAINT "fkpedidodeau349532" FOREIGN KEY ("disponibilidadeiddisponibilidade") REFERENCES "disponibilidade"("iddisponibilidade") ON DELETE NO ACTION ON UPDATE NO ACTION;
